...
import { Wallet, ArrowUpRight, ArrowDownLeft, Plus, Clock, Award, TrendingUp, Send, Loader2 } from 'lucide-react'
...
export default function WalletPage() {
  ...
  async function loadData() {
    ...
    const [balRes, txRes] = await Promise.all([
      ...
      fetch('/api/civict/transactions', { headers: { 'Authorization': `Bearer ${token}` } }).then(r => r.json())
    ])
