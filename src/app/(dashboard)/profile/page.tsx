    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="bg-card dark:bg-[#11241b] border border-border dark:border-[#1f3a2c] rounded-xl">
        <div className="pt-5 px-5 pb-5 flex items-center gap-6 flex-wrap">
          <div className="relative w-20 h-20 rounded-full bg-forest text-white font-serif text-2xl font-black flex items-center justify-center shrink-0 overflow-hidden border-2 border-dashed border-border">
          ...
          <div>
            ...
            <p className="text-xs text-forest mt-1 flex items-center gap-1 cursor-pointer">
      ...
      <div className="bg-card dark:bg-[#11241b] border border-border dark:border-[#1f3a2c] rounded-xl">
        ...
        <div className="px-5 py-4 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="text-sm font-semibold text-ink mb-1.5 block">Phone</label>
              <Input value={form.phone} onChange={e => setForm({...form, phone: e.target.value})} />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-sm font-semibold text-ink mb-1.5 block">State</label>
              <Input value={form.state} onChange={e => setForm({...form, state: e.target.value})} />
            </div>
            <div>
              <label className="text-sm font-semibold text-ink mb-1.5 block">LGA</label>
              <Input value={form.lga} onChange={e => setForm({...form, lga: e.target.value})} />
            </div>
          </div>
          <div>
            <label className="text-sm font-semibold text-ink mb-1.5 block">Ward</label>
          ...
          <div>
            ...
            <textarea value={form.bio} onChange={e => setForm({...form, bio: e.target.value})} rows={3}
              className="w-full px-3.5 py-2.5 text-sm text-ink bg-card border border-border rounded-lg focus:outline-none focus:border-gold focus:ring-3 focus:ring-gold/12 resize-y" />
          </div>
