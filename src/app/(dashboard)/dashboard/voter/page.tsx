          ...
          {wardReps.length > 0 && (
            <div className="px-5 py-4">
              ...
              <div className="space-y-3">
                ...
                {/* INVITE FRIENDS LINK (Client Request) */}
          <div className="bg-white border border-border rounded-xl p-5 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gold/10 flex items-center justify-center">
                <i className="fa-solid fa-share-nodes text-gold"></i>
              </div>
              <div>
                <h3 className="font-bold text-sm text-ink">Invite Friends & Earn 50 CIVICT</h3>
                <p className="text-xs text-muted">Share your unique link with family and friends.</p>
              </div>
            </div>
            <div className="flex gap-2 w-full md:w-auto">
              <input 
                ...
                className="w-full md:w-64 text-xs bg-sand border border-border rounded-lg px-3 py-2 text-muted focus:outline-none"
              />
              <button 
                onClick={() => {
